...
* [Reduction](https://github.com/ceteri/https://github.com/adamfabish/Reduction)
* [sumy](https://github.com/miso-belica/sumy) (among other implementations)
...
**[Text Summarization with Pretrained Encoders](https://arxiv.org/abs/1908.08345v2)**
* In this paper, authors showcase how BERT can be usefully applied in text summarization and propose a general framework for both extractive and abstractive models.
 
[Code](https://paperswithcode.com/paper/text-summarization-with-pretrained-encoders#code)
...
Relevant state-of-the-art implementations. For more papers with open sourced code and datasets, I recommend keep track at PapersWithCode.com, session [Text Summarization](https://paperswithcode.com/task/text-summarization)
